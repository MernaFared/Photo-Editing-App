...
class UiImageProvider extends ImageProvider<UiImageProvider> {
  ...
  //         UiImageProvider key, ui.ImageDecoderCallback decode) =>
  //     OneFrameImageStreamCompleter(_loadAsync(key));

  // @override
  // ImageStreamCompleter loadImage(
  //     AssetImage key, // Change UiImageProvider to AssetImage if appropriate
  //     DecoderCallback decode, // Change ui.ImageDecoderCallback to DecoderCallback if appropriate
  //     ) {
  //   return OneFrameImageStreamCompleter(_loadAsync(key as UiImageProvider));
  // }

  // @override
  // ImageStreamCompleter loadImage(
  //     ImageProvider key,
  //     Future<Codec> Function(Uint8List bytes, {bool allowUpscaling, int? cacheHeight, int? cacheWidth}) decode,
  //     ) {
  //   return OneFrameImageStreamCompleter(_loadAsync(key as UiImageProvider));
  //

...
class SecondLoginScreen extends StatefulWidget {
  ...
  @override
  State<SecondLoginScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<SecondLoginScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFormField(
                    ...
                    borderRadius: 10,
                    prefixIcon:   Icon(Icons.key,color: isTextEmpty ? Colors.grey : Colors.black,),

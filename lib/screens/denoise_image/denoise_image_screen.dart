...
class DenoisingImageScreen extends StatefulWidget {
  const DenoisingImageScreen({Key? key}) : super(key: key);

  @override
  State<DenoisingImageScreen> createState() => _DenoisingImageScreenState();
}

class _DenoisingImageScreenState extends State<DenoisingImageScreen> {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<TestHomeCubit,TestHomeStates>(
            listener: (context,state){
              if(state is ImageDenoisingErrorState){
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        state is ImageDenoisingLoadingState ? myCircularIndicator() : InkWell(
                          onTap: (){
                            ...
                            cubit.imageDenoising(cubit.homeImage!);
                            //cubit.removeBackgroundImage( );
                          },
                          child: const ButtonWithImage(text: "Denoise Image", image:'assets/images/eraser.png',

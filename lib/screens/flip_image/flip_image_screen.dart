...
class FlipImageScreen extends StatefulWidget {
  const FlipImageScreen({Key? key}) : super(key: key);

  @override
  State<FlipImageScreen> createState() => _FlipImageScreenState();
}
    ...
    return Scaffold(
        ...
        body: BlocConsumer<TestHomeCubit,TestHomeStates>(
            listener: (context,state){
              if(state is FlipImageErrorState){
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 20,),
                        state is FlipImageLoadingState ? myCircularIndicator() : InkWell(
                          onTap: (){
                            ...
                            if(directionValue == null){
                              showToast(text: "Please select direction", state: ToastStates.WARNING);
                              return;
                            }

                            cubit.flipImage(cubit.homeImage!, directionValue!);


                          },
                          child: const ButtonWithImage(text: "Flip Image", image:'assets/images/eraser.png',
